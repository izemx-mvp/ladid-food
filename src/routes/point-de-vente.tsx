    ...
    <>
      <section className="bg-gradient-to-br from-cream to-white py-16 md:py-24">
        <div className="mx-auto max-w-4xl px-4 text-center md:px-8">
          <h1 className="section-title">Notre Point de Vente</h1>
      ...
      <section className="py-14">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 md:grid-cols-2 md:px-8">
          <div>
            <img src={pdv.url} alt="Point de vente Ladid Food" loading="lazy" className="w-full rounded-3xl object-cover shadow-[var(--shadow-soft)]" />
          ...
          <div>
            ...
            <p className="mt-3 flex items-center gap-2 text-sm text-muted-foreground">
              <MapPin className="h-4 w-4 text-primary" /> Facilement accessible, parking à proximité.
            </p>
          </div>
        </div>
      </section>
